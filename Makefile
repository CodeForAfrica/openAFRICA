...
ckan-release:
	docker build -t openafrica/ckan:2.6.6 contrib/ckan
	docker push openafrica/ckan:2.6.6


solr:
	rm -rf ckan
	wget -nc https://github.com/ckan/ckan/archive/ckan-2.6.6.tar.gz
	mkdir ckan && tar -xf ckan-2.6.6.tar.gz -C ckan --strip-components=1
